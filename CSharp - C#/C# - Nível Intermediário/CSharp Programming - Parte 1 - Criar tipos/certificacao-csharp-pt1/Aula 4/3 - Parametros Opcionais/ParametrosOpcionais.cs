...
namespace certificacao_csharp_roteiro
{
    class ParametrosOpcionais : IAulaItem
    {
        public void Executar()
        {
            ...
            // Um argumento tem que ser fornecido para o primeiro parâmetro
    ...
    class ClienteEspecial
    {
        ...
        // Todos os parâmetros opcionais devem estar por último na assinatura do método
        // Não pode haver um parametro opcional, um obrigatório e mais um opcional nessa ordem.
